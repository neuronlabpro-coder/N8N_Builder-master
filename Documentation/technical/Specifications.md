...
- **Protocol**: HTTPS tunneling via LocalTunnel
- **Command**: `.\Start-LocalTunnel.ps1`
- **URL Format**: `https://n8n-oauth-stable.loca.lt`
- **Purpose**: OAuth callbacks and webhook testing
- **Persistence**: Stable subdomain for consistent OAuth setup
- **Security**: Uses legitimate LocalTunnel service (.loca.lt domain)
